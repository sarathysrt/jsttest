			...
			<form action="AddProcess" method="post" class="contact_form">
				<ul>
					...
					<li>
						...
						<input type="text" name="processName" placeholder="" required />
					</li> 
						<%
					...
					<li>
						...
						<input type="text" name="processTime" placeholder="20150608" required />
					</li>
					<li>
						<label >
							Process Location:
						</label>
						<input type="text" name="processPlace" placeholder="place" required />
					</li>
					<li>
						<label >
							Process number:
